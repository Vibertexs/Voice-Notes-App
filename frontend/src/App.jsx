...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {screen.name === 'library' && library && <LibraryView data={library} allFolders={allFolders} onOpenFolder={openLibrary} onOpenWorkspace={openWorkspace} onSearch={() => setScreen({ name: 'search' })} onSettings={() => setSettingsOpen(true)} onNewFolder={() => setFolderDialog(true)} onRecord={() => startCapture()} onUpload={uploadFiles} onDeleteMaterial={deleteMaterial} onMoveWorkspace={moveWorkspace} showArchived={showArchived} onToggleArchived={(next) => openLibrary(null, { archived: next })} onArchiveFolder={setFolderArchived} onRecolorFolder={recolorFolder} onDeleteFolder={deleteFolder} />}
